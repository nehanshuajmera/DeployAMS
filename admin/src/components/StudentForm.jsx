      ...
      <div className="flex justify-start items-center flex-col md:flex-row gap-5 flex-1">
        ...
        <div className="relative w-full grid grid-cols-3 flex-1 md:flex md:justify-start md:gap-5">
          ...
          <div className="relative col-span-2">
            ...
            />
            <span className="ml-2 text-lg text-primary">*</span>
            <p className="absolute text-sm z-10 text-primary left-0 top-[80%] md:top-[100%] hidden peer-invalid/programme:block">
              Incorrect input
            </p>
          </div>
        </div>
        ...
        <div className="relative w-full grid grid-cols-3 md:flex md:justify-start md:gap-5 flex-1">
          ...
          <div className="relative col-span-2">
            ...
            />
            <span className="ml-2 text-lg text-primary">*</span>
            <p className="absolute text-sm text-primary left-20 top-[100%] hidden peer-invalid/faculty:block">
              Incorrect input
            </p>
          </div>
        </div>
      ...
      <div className="flex justify-start items-center flex-col md:flex-row gap-5 flex-1">
        ...
        <div className="relative w-full grid grid-cols-3 flex-1 md:flex md:justify-start md:gap-5">
          ...
          <div className="relative col-span-2">
            ...
            />
            <span className="ml-2 text-lg text-primary">*</span>
            <p className="absolute text-sm z-10 text-primary left-0 top-[80%] md:top-[100%] hidden peer-invalid/specialisation:block">
              Incorrect input
            </p>
          </div>
        </div>
        ...
        <div className="relative w-full grid grid-cols-3 md:flex md:justify-start md:gap-5 flex-1">
          ...
          <div className="relative col-span-2">
            ...
            />
            <span className="ml-2 text-lg text-primary">*</span>
            <p className="absolute text-sm text-primary left-20 top-[100%] hidden peer-invalid/year:block">
              Incorrect input
            </p>
          </div>
        </div>
